...
public class CrptApi {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                ...
                if (statusCode == 200) {
                    ...
                    System.out.println("Не удалось создать документ. Код состояния: " + statusCode);
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        ...
        Product product1 = new Product("cert1", "2024-05-06", "123", "owner1", "producer1", "2024-05-06", "tnved1", "uit1", "uitu1");
        Product product2 = new Product("cert2", "2024-05-06", "456", "owner2", "producer2", "2024-05-06", "tnved2", "uit2", "uitu2");
        List<Product> products = new ArrayList<>();
        products.add(product1);
        products.add(product2);

        // Создание объекта Document
        Document document = new Document(description, "doc123", "approved", "type1", true, "owner_inn", "participant_inn", "producer_inn", "2024-05-06", "type2", products, "2024-05-06", "reg123");
